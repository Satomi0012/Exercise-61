...
int a = InputNumbers("Введите число строк 1 матрицы: ");
int b = InputNumbers("Введите число столбцов 1 матрицы (и строк 2): ");
int c = InputNumbers("Введите число столбцов 2 матрицы: ");
